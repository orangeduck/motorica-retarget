...
filenames = [f[:-4] for f in os.listdir('C:/Dev/motorica-retarget/fbx') if f.endswith('.fbx')]

for file in filenames:
    
    input_file = 'C:/Dev/motorica-retarget/fbx/'+file+'.fbx'
    output_file = 'C:/Dev/motorica-retarget/bvh/'+file+'.bvh'
